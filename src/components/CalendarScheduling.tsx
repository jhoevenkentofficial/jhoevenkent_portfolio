...
const CALENDAR_PROJECTS: Project[] = [
  {
    ...
    description: 'Intelligent appointment scheduling system with real-time availability, automated reminders, and seamless calendar synchronization.',
    tags: ['Calendar', 'Booking', 'Scheduling', 'Automation'],
    image: projectImages['cal-1'],
    demoUrl: '#',
    githubUrl: '#',
    featured: true
  },
  {
    ...
    category: 'Calendar Scheduling',
    description: 'Comprehensive event planning and management solution with calendar integration, attendee tracking, and automated notifications.',
    tags: ['Events', 'Calendar', 'Management', 'Notifications'],
    image: projectImages['cal-2'],
    demoUrl: '#',
    githubUrl: '#',
    featured: true
  },
  {
    id: 'cal-3',
    title: 'Resource Scheduling System',
    category: 'Calendar Scheduling',
    description: 'Advanced resource allocation and scheduling platform for managing equipment, rooms, and team availability.',
    tags: ['Resource', 'Scheduling', 'Management', 'Planning'],
    image: projectImages['cal-3'],
    demoUrl: '#',
    githubUrl: '#',
    featured: true
  },
  {
    ...
    category: 'Calendar Scheduling',
    description: 'Smart meeting room reservation system with real-time availability, booking management, and integration with team calendars.',
    tags: ['Meeting', 'Booking', 'Rooms', 'Calendar'],
    image: projectImages['cal-4'],
    demoUrl: '#',
    githubUrl: '#',
    featured: true
  },
  {
    ...
    category: 'Calendar Scheduling',
    description: 'Automated appointment reminder and confirmation system with multi-channel notifications and calendar sync.',
    tags: ['Reminders', 'Appointments', 'Notifications', 'Sync'],
    image: projectImages['cal-5'],
    demoUrl: '#',
    githubUrl: '#',
    featured: true
  },
  {
    id: 'cal-6',
    title: 'Schedule Optimization Tool',
    category: 'Calendar Scheduling',
    description: 'AI-powered scheduling optimization that analyzes patterns and suggests optimal time slots for maximum productivity.',
    tags: ['AI', 'Optimization', 'Scheduling', 'Analytics'],
    image: projectImages['cal-6'],
    demoUrl: '#',
    githubUrl: '#',
    featured: true
  }
...
export default function CalendarScheduling() {
  ...
  const nextSlide = useCallback(() => {
    setDirection(1);
    setActiveSlide(prev => (prev + 1) % CALENDAR_PROJECTS.length);
  }, []);

  const prevSlide = () => {
    setDirection(-1);
    setActiveSlide(prev => (prev - 1 + CALENDAR_PROJECTS.length) % CALENDAR_PROJECTS.length);
  };
  ...
  const featured = CALENDAR_PROJECTS[activeSlide];
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">6+</p>
              <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Calendar Solutions</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">Real-time</p>
              <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Sync</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">100%</p>
              <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Automated</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">Multi-platform</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black font-display text-brand-navy tracking-tight">Calendar & Scheduling Projects</h2>
            </div>
          ...
          <motion.div layout className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {CALENDAR_PROJECTS.map((project, idx) => (
              <motion.div
                key={project.id}
                layout
                initial={{ opacity: 0, y: 40 }}
