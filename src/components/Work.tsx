...
import { ExternalLink, Github, ChevronLeft, ChevronRight, Quote, ArrowRight, Star, Eye, Code, Layers, Cpu, Zap, X } from 'lucide-react';
...
export default function Work() {
  ...
  const nextSlide = useCallback(() => {
    setDirection(1);
    setActiveSlide(prev => (prev + 1) % WEB_PROJECTS.length);
  }, []);

  const prevSlide = () => {
    setDirection(-1);
    setActiveSlide(prev => (prev - 1 + WEB_PROJECTS.length) % WEB_PROJECTS.length);
  };
  ...
  const featured = WEB_PROJECTS[activeSlide];
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">15+</p>
              <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Web Projects</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">React</p>
              <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Primary Stack</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">100%</p>
              <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Client Satisfaction</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-black font-display text-brand-navy">Full Stack</p>
              <p className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Development</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black font-display text-brand-navy tracking-tight">All Web Projects</h2>
            </div>
                ...
                <div className="p-6 text-left">
                  <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    {project.tags.length > 3 && (
                      <span className="text-[9px] font-bold text-slate-400 px-1">+{project.tags.length - 3}</span>
                    )}
                  </div>
